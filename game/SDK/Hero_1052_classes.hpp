...
public:
	...
	uint8                                         Pad_2589[0xF];                                     // 0x2589(0x000F)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_C2[0x6];                                       // 0x00C2(0x0006)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_913[0x5];                                      // 0x0913(0x0005)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_932[0x2];                                      // 0x0932(0x0002)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_938[0x48];                                     // 0x0938(0x0048)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_1890[0x20];                                    // 0x1890(0x0020)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
// 0x0FC0 (0x3FB0 - 0x2FF0)
class ULinLieMovementComponent final : public UCharacterWallRunningComponent
{
public:
	float                                         MaxGroundSlop;                                     // 0x2FE8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTraceDestructible;                                // 0x2FEC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTraceSceneCommoned;                               // 0x2FED(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTraceAirWall;                                     // 0x2FEE(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FEF[0x1];                                     // 0x2FEF(0x0001)(Fixing Size After Last Property [ Chaos Dumper ])
	float                                         MinWallHeight;                                     // 0x2FF0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WallZSpeed;                                        // 0x2FF4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FF8[0x8];                                     // 0x2FF8(0x0008)(Fixing Size After Last Property [ Chaos Dumper ])
	struct FMarvelAbilityTraceContext             EffectiveTraceContext;                             // 0x3000(0x0F90)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	class ALinLieCharacter*                       LinLieCharacter;                                   // 0x3F90(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3F98[0x18];                                    // 0x3F98(0x0018)(Fixing Struct Size After Last Property [ Chaos Dumper ])
