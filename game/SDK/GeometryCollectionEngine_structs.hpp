...
{
public:
	uint8                                         Pad_0[0xD0];                                       // 0x0000(0x00D0)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_32[0xE];                                       // 0x0032(0x000E)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_42[0xE];                                       // 0x0042(0x000E)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_63[0xD];                                       // 0x0063(0x000D)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_B3[0xD];                                       // 0x00B3(0x000D)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
