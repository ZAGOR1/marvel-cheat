...
public:
	...
	uint8                                         Pad_D0[0x4D8];                                     // 0x00D0(0x04D8)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_5B0[0x238];                                    // 0x05B0(0x0238)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_818[0x8];                                      // 0x0818(0x0008)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_58[0xA0];                                      // 0x0058(0x00A0)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_58[0xD8];                                      // 0x0058(0x00D8)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_F8[0x30];                                      // 0x00F8(0x0030)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_F8[0xA0];                                      // 0x00F8(0x00A0)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_F8[0x10];                                      // 0x00F8(0x0010)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_F8[0x48];                                      // 0x00F8(0x0048)(Fixing Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_58[0x238];                                     // 0x0058(0x0238)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_118[0x50];                                     // 0x0118(0x0050)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_38[0x35C];                                     // 0x0038(0x035C)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_3B0[0xB0];                                     // 0x03B0(0x00B0)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_478[0x120];                                    // 0x0478(0x0120)(Fixing Struct Size After Last Property [ Chaos Dumper ])
