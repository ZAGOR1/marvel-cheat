...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0DD219C0;
	constexpr int32 AppendString      = 0x00000000;
	constexpr int32 GNames            = 0x0DC6AC00;
	constexpr int32 GWorld            = 0x0DED1E10;
	constexpr int32 ProcessEvent      = 0x0102E760;
	constexpr int32 ProcessEventIdx   = 0x00000050;
	constexpr int32 PostRender        = 0x00000000;
	constexpr int32 PostRenderIdx     = 0x00000000;
	constexpr int32 ModeIndex		  = 0x00000050; // uint8
}
...
{
public:
	uint8                                         Pad_0[0x2];                                        // 0x0000(0x0002)(Fixing Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_0[0x4];                                        // 0x0000(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_48[0x30];                                      // 0x0048(0x0030)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
