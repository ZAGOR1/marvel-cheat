...
{
public:
	uint8                                         Pad_30[0x4];                                       // 0x0030(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_44[0x1C];                                      // 0x0044(0x001C)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_44B[0x5];                                      // 0x044B(0x0005)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_30[0xB0];                                      // 0x0030(0x00B0)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_220[0x18];                                     // 0x0220(0x0018)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_48[0x28];                                      // 0x0048(0x0028)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_30[0x2A0];                                     // 0x0030(0x02A0)(Fixing Size After Last Property [ Chaos Dumper ])
	struct FMovieSceneEntitySystemGraph           SystemGraph;                                       // 0x02D0(0x0250)(NativeAccessSpecifierPublic)
	uint8                                         Pad_520[0x308];                                    // 0x0520(0x0308)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_40[0x58];                                      // 0x0040(0x0058)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_64[0x1];                                       // 0x0064(0x0001)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_66[0x2];                                       // 0x0066(0x0002)(Fixing Size After Last Property [ Chaos Dumper ])
	TArray<int32>                                 RowsDisabled;                                      // 0x0068(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_78[0x4];                                       // 0x0078(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_DB[0x1D];                                      // 0x00DB(0x001D)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_30[0x208];                                     // 0x0030(0x0208)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_299[0x3];                                      // 0x0299(0x0003)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         BitPad_29C_1 : 4;                                  // 0x029C(0x0001)(Fixing Bit-Field Size Between Bits [ Chaos Dumper ])
	...
	uint8                                         Pad_2DC[0x4];                                      // 0x02DC(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_368[0x90];                                     // 0x0368(0x0090)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_40C[0x4];                                      // 0x040C(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_428[0xB0];                                     // 0x0428(0x00B0)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_30[0x70];                                      // 0x0030(0x0070)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_110[0x18];                                     // 0x0110(0x0018)(Fixing Struct Size After Last Property [ Chaos Dumper ])
