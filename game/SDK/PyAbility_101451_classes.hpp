...
public:
	...
	TMulticastInlineDelegate<void(struct FHitResult& ImpactResult)> OnProjectileHit_PyProjectile_10145101;             // 0x3110(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_979[0x7];                                      // 0x0979(0x0007)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_998[0x8];                                      // 0x0998(0x0008)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_1931[0x7];                                     // 0x1931(0x0007)(Fixing Size After Last Property [ Chaos Dumper ])
