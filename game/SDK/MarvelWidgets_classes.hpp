...
public:
	...
	uint8                                         Pad_D51[0x7];                                      // 0x0D51(0x0007)(Fixing Size After Last Property [ Chaos Dumper ])
	struct FGameplayTagContainer                  TypeTags;                                          // 0x0D58(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	uint8                                         Pad_DC0[0x10];                                     // 0x0DC0(0x0010)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_D71[0xF];                                      // 0x0D71(0x000F)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_D79[0x7];                                      // 0x0D79(0x0007)(Fixing Size After Last Property [ Chaos Dumper ])
	struct FGameplayTagContainer                  TypeTags;                                          // 0x0D80(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	uint8                                         Pad_DE8[0x8];                                      // 0x0DE8(0x0008)(Fixing Struct Size After Last Property [ Chaos Dumper ])
