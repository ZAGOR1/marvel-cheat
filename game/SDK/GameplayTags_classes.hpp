...
{
public:
	uint8                                         Pad_30[0x170];                                     // 0x0030(0x0170)(Fixing Size After Last Property [ Chaos Dumper ])
	TMap<class FName, struct FGameplayTagSource>  TagSources;                                        // 0x01A0(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F0[0x90];                                     // 0x01F0(0x0090)(Fixing Size After Last Property [ Chaos Dumper ])
