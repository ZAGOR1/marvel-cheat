...
public:
	...
	uint8                                         Pad_2659[0x7];                                     // 0x2659(0x0007)(Fixing Size After Last Property [ Chaos Dumper ])
	TMulticastInlineDelegate<void(struct FVector& ImpactPoint, class AMarvelBaseCharacter* target_actor)> DelegateGrabEnemyInAir;                            // 0x2660(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
