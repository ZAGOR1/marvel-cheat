...
public:
	...
	uint8                                         Pad_2BE[0x52];                                     // 0x02BE(0x0052)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_8[0x38];                                       // 0x0008(0x0038)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_10[0x70];                                      // 0x0010(0x0070)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_1BA[0x6];                                      // 0x01BA(0x0006)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_21B[0x6D];                                     // 0x021B(0x006D)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_2A8[0x88];                                     // 0x02A8(0x0088)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
{
public:
	uint8                                         Pad_10[0x30];                                      // 0x0010(0x0030)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
{
public:
	uint8                                         Pad_10[0x48];                                      // 0x0010(0x0048)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_D0[0x10];                                      // 0x00D0(0x0010)(Fixing Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_50[0x38];                                      // 0x0050(0x0038)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_12C[0x1C4];                                    // 0x012C(0x01C4)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
{
public:
	uint8                                         Pad_0[0x34];                                       // 0x0000(0x0034)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_A4[0x12C];                                     // 0x00A4(0x012C)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_12E[0x12];                                     // 0x012E(0x0012)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         BitPad_48_0 : 2;                                   // 0x0048(0x0001)(Fixing Bit-Field Size Between Bits [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_F4[0x14];                                      // 0x00F4(0x0014)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_214[0x4];                                      // 0x0214(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	struct FPBIKSolver                            Solver;                                            // 0x0218(0x0068)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_280[0x20];                                     // 0x0280(0x0020)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_2A1[0x7];                                      // 0x02A1(0x0007)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
{
public:
	uint8                                         Pad_70[0x8];                                       // 0x0070(0x0008)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_1D4[0x4];                                      // 0x01D4(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_1DA[0x6];                                      // 0x01DA(0x0006)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
{
public:
	uint8                                         Pad_10[0x38];                                      // 0x0010(0x0038)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_8D[0xB];                                       // 0x008D(0x000B)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_11B[0x5];                                      // 0x011B(0x0005)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_1C0[0x40];                                     // 0x01C0(0x0040)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_E2[0x2];                                       // 0x00E2(0x0002)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_E8[0x4];                                       // 0x00E8(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_11D[0x6B];                                     // 0x011D(0x006B)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
