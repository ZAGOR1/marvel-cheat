...
public:
	...
	uint8                                         Pad_E52[0x6];                                      // 0x0E52(0x0006)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_EC4[0x4];                                      // 0x0EC4(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_EEC[0x4];                                      // 0x0EEC(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_F6D[0x3];                                      // 0x0F6D(0x0003)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_1028[0x80];                                    // 0x1028(0x0080)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_5C00[0xB0];                                    // 0x5C00(0x00B0)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_E5C[0x4];                                      // 0x0E5C(0x0004)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_25D0[0x18];                                    // 0x25D0(0x0018)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_25FC[0x4];                                     // 0x25FC(0x0004)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_2608[0x28];                                    // 0x2608(0x0028)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_ED8[0x28];                                     // 0x0ED8(0x0028)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_25A0[0x70];                                    // 0x25A0(0x0070)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_91A[0x6];                                      // 0x091A(0x0006)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_93F[0x1];                                      // 0x093F(0x0001)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_94C[0x3C];                                     // 0x094C(0x003C)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_990[0x60];                                     // 0x0990(0x0060)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	TMulticastInlineDelegate<void(struct FHitResult& Impact)> OnMoveBlock_ThreadSafe;                            // 0x1868(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1890[0xC];                                     // 0x1890(0x000C)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_189F[0x1];                                     // 0x189F(0x0001)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_18B9[0x7];                                     // 0x18B9(0x0007)(Fixing Struct Size After Last Property [ Chaos Dumper ])
