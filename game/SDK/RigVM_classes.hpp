...
{
public:
	uint8                                         Pad_3F0[0x8];                                      // 0x03F0(0x0008)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_48[0x20];                                      // 0x0048(0x0020)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_138[0x38];                                     // 0x0138(0x0038)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_1D0[0x98];                                     // 0x01D0(0x0098)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_270[0x40];                                     // 0x0270(0x0040)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_40[0xC8];                                      // 0x0040(0x00C8)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_280[0x40];                                     // 0x0280(0x0040)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_2B0[0x28];                                     // 0x02B0(0x0028)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_240[0x18];                                     // 0x0240(0x0018)(Fixing Size After Last Property [ Chaos Dumper ])
	TArray<class FName>                           EventQueue;                                        // 0x0258(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_268[0x90];                                     // 0x0268(0x0090)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_308[0x40];                                     // 0x0308(0x0040)(Fixing Struct Size After Last Property [ Chaos Dumper ])
