...
public:
	...
	uint8                                         Pad_58[0x18];                                      // 0x0058(0x0018)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_58[0x38];                                      // 0x0058(0x0038)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_58[0x48];                                      // 0x0058(0x0048)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_58[0x30];                                      // 0x0058(0x0030)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_50[0x60];                                      // 0x0050(0x0060)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_50[0x58];                                      // 0x0050(0x0058)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_50[0x68];                                      // 0x0050(0x0068)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_21D8[0x8C];                                    // 0x21D8(0x008C)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_2268[0x18];                                    // 0x2268(0x0018)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_AD8[0x88];                                     // 0x0AD8(0x0088)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_B80[0x80];                                     // 0x0B80(0x0080)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_58[0x148];                                     // 0x0058(0x0148)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_4A8[0x20];                                     // 0x04A8(0x0020)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_4D9[0x5F];                                     // 0x04D9(0x005F)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_4CE[0x2];                                      // 0x04CE(0x0002)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_4D4[0x54];                                     // 0x04D4(0x0054)(Fixing Size After Last Property [ Chaos Dumper ])
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x0528(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_538[0xA0];                                     // 0x0538(0x00A0)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_9C[0xFC];                                      // 0x009C(0x00FC)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_30[0x1B0];                                     // 0x0030(0x01B0)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_1E2[0x6];                                      // 0x01E2(0x0006)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_538[0x30];                                     // 0x0538(0x0030)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_5D3[0x7D];                                     // 0x05D3(0x007D)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_4C0[0x60];                                     // 0x04C0(0x0060)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_603[0x7D];                                     // 0x0603(0x007D)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_AD0[0x60];                                     // 0x0AD0(0x0060)(Fixing Struct Size After Last Property [ Chaos Dumper ])
