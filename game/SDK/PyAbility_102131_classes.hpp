...
public:
	...
	TMulticastInlineDelegate<void(struct FHawkeyeArrowData& ArrowData)> QATestArrowData;                                   // 0x25B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_DB1[0x3];                                      // 0x0DB1(0x0003)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	TMulticastInlineDelegate<void(bool is_hidden, struct FHitResult& ImpactResult)> DelegateShowArrowMesh;                             // 0x3118(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
