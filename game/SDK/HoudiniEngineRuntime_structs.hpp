...
public:
	...
	uint8                                         Pad_B[0x1];                                        // 0x000B(0x0001)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_8[0x90];                                       // 0x0008(0x0090)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
{
public:
	uint8                                         Pad_0[0xB0];                                       // 0x0000(0x00B0)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_D2[0x6];                                       // 0x00D2(0x0006)(Fixing Size After Last Property [ Chaos Dumper ])
	...
	uint8                                         Pad_10C[0x174];                                    // 0x010C(0x0174)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_8A[0x6];                                       // 0x008A(0x0006)(Fixing Struct Size After Last Property [ Chaos Dumper ])
};
...
public:
	...
	uint8                                         Pad_1DD[0x3];                                      // 0x01DD(0x0003)(Fixing Size After Last Property [ Chaos Dumper ])
