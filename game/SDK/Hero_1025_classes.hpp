...
public:
	...
	uint8                                         Pad_D98[0x20];                                     // 0x0D98(0x0020)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_2F94[0xC];                                     // 0x2F94(0x000C)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	TMulticastInlineDelegate<void(EAdsorbState AdsorbState)> AdsorbStateUpdatedDispatcher;                      // 0x2588(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_EBA[0x16];                                     // 0x0EBA(0x0016)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_17A8[0x8];                                     // 0x17A8(0x0008)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_D8C[0x4];                                      // 0x0D8C(0x0004)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_1871[0xF];                                     // 0x1871(0x000F)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_C20[0x30];                                     // 0x0C20(0x0030)(Fixing Struct Size After Last Property [ Chaos Dumper ])
...
{
public:
	uint8                                         Pad_A60[0x18];                                     // 0x0A60(0x0018)(Fixing Size After Last Property [ Chaos Dumper ])
...
public:
	...
	uint8                                         Pad_188[0x50];                                     // 0x0188(0x0050)(Fixing Struct Size After Last Property [ Chaos Dumper ])
